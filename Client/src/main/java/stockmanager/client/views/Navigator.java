...
public class Navigator {
    ...
    public static void goToDashboard() {
        stockmanager.client.views.VueDashboard dashboard = new VueDashboard();
    ...
    public static void goToProduitsExpires() throws IOException, URISyntaxException {
        VueProduitsExpires vue = new stockmanager.client.views.VueProduitsExpires();
    ...
    public static void goToVentesDechets() throws IOException, URISyntaxException {
        stockmanager.client.views.VueVentesDechets vue = new stockmanager.client.views.VueVentesDechets();
        Scene scene = new Scene(vue, 900, 600);
        mainStage.setScene(scene);
    ...
    public static void goToLocalisationRayons() throws IOException {
        VueLocalisationRayons vue = new stockmanager.client.views.VueLocalisationRayons();
    ...
    public static void goToGestionCommandes() throws IOException {
        stockmanager.client.views.VueGestionCommandes vue = new VueGestionCommandes();
        Scene scene = new Scene(vue, 900, 600);
        mainStage.setScene(scene);
    ...
    public static void goToFournisseurs() throws IOException {
        stockmanager.client.views.VueFournisseurs vue = new VueFournisseurs();
        Scene scene = new Scene(vue, 1000, 600);
        mainStage.setScene(scene);
