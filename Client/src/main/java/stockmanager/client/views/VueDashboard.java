...
public class VueDashboard extends BorderPane {
    ...
    public VueDashboard() {
        ...
        boutonProduitsExpires.setOnAction(e -> {
            try {
                stockmanager.client.views.Navigator.goToProduitsExpires();
        ...
        boutonVentesDechets.setOnAction(e -> {
            try {
                stockmanager.client.views.Navigator.goToVentesDechets();
            } catch (IOException | URISyntaxException ex) {
                throw new RuntimeException(ex);
            }
        });
        ...
        boutonLocalisationRayons.setOnAction(e -> {
            try {
                stockmanager.client.views.Navigator.goToLocalisationRayons();
        ...
        boutonCommandes.setOnAction(e -> {
            try {
                stockmanager.client.views.Navigator.goToGestionCommandes();
            } catch (IOException ex) {
                throw new RuntimeException(ex);
            }
        });
        ...
        boutonFournisseurs.setOnAction(e -> {
            try {
                stockmanager.client.views.Navigator.goToFournisseurs();
            } catch (IOException ex) {
                throw new RuntimeException(ex);
            }
        });
